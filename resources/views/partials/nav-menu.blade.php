...
<div class="d-flex gap-2 flex-wrap">
    <a href="{{ route('dashboard') }}"
        class="btn btn-nav-modern {{ isset($active) && $active == 'dashboard' ? 'active' : '' }}">
        <i class="bi bi-speedometer2 me-2"></i>Dashboard
    </a>
    <a href="{{ route('repairs.index') }}"
        class="btn btn-nav-modern {{ isset($active) && $active == 'repairs' ? 'active' : '' }}">
        <i class="bi bi-tools me-2"></i>Data Perbaikan
    </a>
    <a href="{{ route('donations.index') }}"
        class="btn btn-nav-modern {{ isset($active) && $active == 'donations' ? 'active' : '' }}">
