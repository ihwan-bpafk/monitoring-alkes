        ...
        <div class="card shadow-sm border-0 mb-4">
            ...
            <div class="card-body">
                <div class="row g-3">
                    ...
                    <div class="col-6"><small class="text-muted d-block">Kategori / Grade</small><strong>{{ $repair->kategori }} - <span class="text-danger">{{ $repair->grade_kerusakan }}</span></strong></div>
