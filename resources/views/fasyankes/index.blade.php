...
<div class="container-fluid">
    ...
    <div class="card border-0 shadow-sm mb-3">
        <div class="card-body py-2">
            <form action="{{ route('fasyankes.index') }}" method="GET" class="ajax-search" style="max-width: 400px;">
                <div class="input-group input-group-sm">
                    <span class="input-group-text bg-white border-end-0 text-muted"><i class="bi bi-search"></i></span>
                    <input type="text" name="search" class="form-control border-start-0 ps-0 shadow-none" placeholder="Cari fasyankes..." value="{{ request('search') }}" oninput="debounceSearch(this.form)">
                </div>
            </form>
        </div>
    </div>
